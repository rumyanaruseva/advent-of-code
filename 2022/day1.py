...
# the third Elf (with 11000 Calories), then the fifth Elf (with 10000 Calories).
...
print ("Day 1, part 1: ", maxAll[-1])
print ("Day 1, part 2: ", maxAll[-1] + maxAll[-2] + maxAll[-3])
